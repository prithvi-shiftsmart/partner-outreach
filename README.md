...
| File | Covers |
|------|--------|
| `orientation_process.md` | In-App Orientation (9 modules + cert call + profile photo + BGC, ~30 min + ~5 min, $10 after first shift), entry via "Unlock nearby shifts" card on Home tab with Shifts tab fallback, in-person types (shadow, ambassador), DL→OP funnel steps, partners can pick up shifts while BGC pending |
| `pay_rates.md` | Rates by company (CKP $15-17, Pepsi $17-20, DG $15-18), DxGy bonuses, orientation pay ($10 after first shift). Includes guardrail: don't quote exact rates, say "most shifts are $10-20/hr" and point to app |
