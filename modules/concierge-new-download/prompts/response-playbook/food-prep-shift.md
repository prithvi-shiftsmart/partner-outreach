...
**Scope**: On-shift questions for Circle K food prep partners. Food prep only for now — no other companies or shift types.
...
- "How do I use Menu Pilot?"
- "Upshop vs Menu Pilot — which do I use?"
...
Cook what the Shiftsmart app tells you. If store staff asks you not to cook something, log it as "store request" in the app.
