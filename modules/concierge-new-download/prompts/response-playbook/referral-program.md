...
- "I was referred" / "[name] referred me" / "someone referred me"
- "how do I refer" / "can I invite" / "referral link" / "referral code"
- "where's my bonus" / "referral bonus" / "promo"
- Unprompted mention of a referrer's name
...
- If window expires, offer is gone

## Where to Find the Referral Page
- Primary path: **Profile → Promos → "Invite Friends, Earn Money"**
- Secondary path: bottom of the **Home** tab → tap **"Learn more"**
- Share action: blue **Share** button at the bottom of the Promos page

## General Rule (applies to ALL referral replies)
Every reply must direct the partner to the in-app **Profile → Promos → "Invite Friends, Earn Money"** page for full detail and live status tracking (referrer name, countdown, qualifying-shift count, payout state). The Promos page is the source of truth; the SMS reply is just the nudge. Do NOT answer with general facts only — always end with or include a pointer to the Promos page.
...
- Say only Circle K shifts count
- Proactively mention orientation-vs-referral-shift distinction (only if asked)
