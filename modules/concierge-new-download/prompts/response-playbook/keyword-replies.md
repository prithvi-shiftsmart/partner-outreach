...
Both HELP and START ultimately point to the same place: the **"In-app orientation"** card on the Home tab (look for the blue **"Required to unlock shifts"** banner and the **{{orientation_payout_cents}}** amount on the right). Tone is what differs.

## HELP Response — Default Copy

> Happy to walk you through it. Open the Shiftsmart app, stay on the **Home** tab, and find the white card with the blue **"Required to unlock shifts"** banner, titled **"In-app orientation"** with **{{orientation_payout_cents}}** on the right. Tap **Get started** → **Start learning modules**. 4 steps, about 45 minutes on your phone. Any questions?
...
- **Same destination for both**: HELP and START both route to the Home tab **"In-app orientation"** card (blue **"Required to unlock shifts"** banner, **{{orientation_payout_cents}}**). Don't give partners different entry points based on keyword.
