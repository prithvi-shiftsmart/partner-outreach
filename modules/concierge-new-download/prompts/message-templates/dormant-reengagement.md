...
Variants for partners who went quiet for 48+ hours after a prior outreach. **Send one message only.** If no response, stop and flag for human review — do not auto-send a second dormant nudge. See `_config/funnel_stages/dormant.md` for the state-level rules. No em dashes in any partner-facing copy.
...
## Variant C-chosen — Both-Deal Zone, partner had chosen a company

Hey {first_name}, checking back in. The {company} orientation is still there when you're ready: {duration: "about 45 minutes" for Circle K, "about 20 to 30 minutes" for Dollar General} on your phone, $10 once the background check submits, and it unlocks {company} shifts in your area. No pressure either way.

Reply HELP if you want to pick it up, or STOP to unsubscribe.

## Variant C-neutral — Both-Deal Zone, partner never chose

Hey {first_name}, checking back in. There are still two ways to start earning near you: Circle K (food prep, orientation about 45 min) or Dollar General (shelves and price tags, about 20 to 30 min). Both pay $10 when you finish the orientation.
