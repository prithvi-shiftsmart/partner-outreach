...
Applies only when the partner is in a confirmed both-deal zone (Circle K + Dollar General both live). See HARD RULES 20-22 for the zone-confirmation and cross-sell limits.
