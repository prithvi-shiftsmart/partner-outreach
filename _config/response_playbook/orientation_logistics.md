...
## If Partner Can't Find the "Unlock nearby shifts" Card / Says It's Not Working
First response: just restate the steps clearly. Don't troubleshoot yet.
"On the Home tab of the Shiftsmart app, look for the 'Earn $10 today, unlock shifts' section and tap 'Start earning' on the 'Unlock nearby shifts' card."

Only if they come back and say they STILL can't see the card, give the fallback path:
"You can also go to the Shifts tab, find a Circle K Food Prep shift, and tap it — the shift will walk you into the in-app orientation from there."

If that still doesn't work, push them toward an in-person orientation (only if confirmed available in their market):
"No worries — you can also do an in-person orientation where you'd shadow an experienced partner on a real shift. You'd learn everything hands-on and get paid the full shift rate, which is more than the in-app orientation. Want me to find one near you?"
