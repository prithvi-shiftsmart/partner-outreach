...
row = add_test(ws, row,
    ...
    "Hey Marcus, just checking in -- still interested in picking up shifts with Circle K? The In-App Orientation takes about 30 minutes and you'll earn $10 when you finish all the steps.\n\nTap here to start: shiftsmart://explore",
    [
...
row = add_test(ws, row,
    "2.3 Trust / legitimacy",
    "Hi Jordan! I'm your Shiftsmart guide. I can answer any questions and help you get your first shift with Circle K.\n\nThe first step is to complete the In-App Orientation -- you can do it right in the app today, takes about 30 minutes, and you'll earn $10 when you finish all the steps. Tap here to start: shiftsmart://explore\n\nAny questions? Just reply to this text.",
    [
