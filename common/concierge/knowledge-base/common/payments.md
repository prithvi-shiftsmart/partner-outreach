...
| "Wrong account" / paid to wrong place | "Message support through in-app chat (message icon, top right) with the shift date, the amount, and the correct account details so the team can look into it." |
